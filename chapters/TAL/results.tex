...
\citep{ILSVRCarxiv14}. Providing quantitative results is not as
...
models of word learning, the collection of feature production norms for ImageNet \citep{ILSVRCarxiv14} would
