...
\citep{karpathy2014deep}, \citep{mao2014explain},
\citep{kiros2014unifying}, \citep{donahue2014long}, \citep{vinyals2014show},  \citep{venugopalan2014translating}, \citep{chen2014learning},  \citep{fang2014captions}. The majority of these
...
\citep{vinyals2014show} use the deep convolutional neural network of
\citep{szegedy2014going} trained on ImageNet to encode the image into a
vector. This representation is then decoded into a sentence using a
Long Short-Term Memory recurrent neural network
\cite{hochreiter1997long}. Words are represented by embedding them
...
\citep{bruni2014multimodal}. In their work, they train multimodal
...
\citep{lazaridou2015combining} propose a multimodal model which learns
...
of the ImageNet dataset \cite{deng2009imagenet} where images are
