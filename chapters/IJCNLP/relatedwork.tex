...
the encoder is trained by minimizing two loss functions: the Image-$L_{2}$ correlation loss, and the $L_{1}$ decoding cross-entropy loss. \cite{Nakayama2016} consider a zero-resource problem,
...
generalisability of a model by requiring it to be useful for more than one task \citep{Caruana1997}.
