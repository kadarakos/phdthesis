...
classification tasks beating simpler approaches such as bag-of-words approaches based on skip-gram
...
represent sentences and a pre-trained convolutional neural network
