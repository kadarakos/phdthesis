...
BBC News data set containing text articles with image illustrations \cite{feng2010visual}.
...
\cite{bruni2012distributional} construct multi-modal representations set of words for which
...
%The first approach to construct a dictionary based on image similarity 
\citep{bergsma2011learning} 
...
%represent each word as the summary of CNN activations of images they
