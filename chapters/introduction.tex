...
learning process and to enrich the representations. The link between human word and concept representation and perceptual-motor
systems has been well established through behavioral neuroscientific experiments \cite{pulvermuller2005brain}.
...
of novel objects based on perceptual cues such as shape \cite{landau1998object}. A number of
...
to as the \emph{grounding problem} \cite{harnad1990symbol}.
...
Probably the first approach to visual word representations was introduced by \cite{feng2010visual}.
Perceptually grounded word representations \cite{bruni2012distributional}. Using bag-of-visual-words \cite{bruni2011distributional}. For a big review check \cite{bruni2014multimodal}. Modern skip-gram + VGG word embeddings \cite{kiela2014learning}. Multi-modal skip-gram \cite{lazaridou2015combining}.
